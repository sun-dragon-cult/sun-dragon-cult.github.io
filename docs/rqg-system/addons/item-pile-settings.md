---
sidebar_position: 20
slug: addons/item-pile-settings
title: Item Pile Settings
tags: [module]
---
This is an incomplete setting for Item Piles. What's missing is defining what items are unique. Running this in the terminal or through a macro will set the settings in Item Piles.
```js
game.itempiles.API.setActorClassType("character");
