...
at least one skill item. See sections about [Creating an Adventurer](getting-started/creating-actor)
and [Foundry Items](/rqg-system/items) for more information.
...
For more detail see [Creating a new actor](getting-started/creating-actor)
