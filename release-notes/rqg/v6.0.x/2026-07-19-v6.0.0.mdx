...
moving any legacy MP/HP max bonus paths to the new `system.effect.add.magicPoints.max` /
`system.effect.add.hitPoints.max` fields described below.
...
#### system.effect.add.magicPoints.max _(on the character)_
...
#### system.effect.add.hitPoints.max _(on the character)_

A bonus to max Hit Points.

#### system.effect.add.skillCategoryModifiers.\<category\> _(on the character)_
...
#### system.effect.add.melee.attack / system.effect.add.melee.parry / system.effect.add.missile.attack / system.effect.add.missile.parry _(on weapon items)_
